...
class register_choice: AppCompatActivity() {
    ...
    private fun register() {
        ...
        if((inputUsername.text.toString().isNotEmpty()) &&
            (inputEmail.text.toString().isNotEmpty()) &&
            (inputPassword.text.toString().isNotEmpty()) &&
            (inputPassword.text.toString() == inputConfirm.text.toString()) &&
            (inputConfirm.text.toString().isNotEmpty()) &&
            (inputGender.getCheckedRadioButtonId() != -1) &&
            (inputAttention.getCheckedRadioButtonId() != -1)) {
                        ...
                        task -> if(task.isSuccessful) {
                            ...
                            databaseref.updateChildren(data).addOnCompleteListener {
                                    task -> if(task.isSuccessful) {
                                        ...
                                        data["home_image3"] = "https://firebasestorage.googleapis.com/v0/b/cucumber-db.appspot.com/o/image%2Fhome-icon.jpg?alt=media&token=fa484be3-75e8-4ab5-b8de-dbe2a062068f"
                                        data["province"] = ""
                                        data["road"] = ""
                                        ...
                                        data1["pet_image3"] = "https://firebasestorage.googleapis.com/v0/b/cucumber-db.appspot.com/o/image%2Fdog-icon.png?alt=media&token=d67c854c-09ae-4274-a893-2784348f821e"
                                        data1["pet_info"] = ""
                                        data1["pet_name"] = ""
                                        data1["pet_sex"] = ""
