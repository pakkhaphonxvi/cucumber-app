...
class Setting : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val spinnerAdapterAttention = context?.let { ArrayAdapter(it,android.R.layout.simple_spinner_item,attention_target) }
        ...
        val spinnerAdapterGender = context?.let{ArrayAdapter(it,android.R.layout.simple_spinner_item,gender_target)}
